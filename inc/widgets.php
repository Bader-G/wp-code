...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Header Top', 'understrap' ),
				'id'            => 'headertop',
				'description'   => __( 'Widget on the top of the header', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="top-header-widget">',
		...
		register_sidebar(
			array(
				...
				'id'            => 'footerbottom',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-bottom-widget">',
				'after_widget'  => '</div><!-- .footerbottom--widget -->',
				'before_title'  => '',
				'after_title'   => '',
			)
		);
