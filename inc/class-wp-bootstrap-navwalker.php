	...
	class Understrap_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && 1 !== $args->depth ) {
				...
				$child_toggler = '<a class="dropdown-toggle" href="#" role="button" id="menu-item-dropdown-'.$item->ID.'" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>';
			} else {
			...
			$item_output .= isset( $args->link_before ) ? $args->link_before . $icon_html . $title . $args->link_after . $child_toggler : '';
			/**
